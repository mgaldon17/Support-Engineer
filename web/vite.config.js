...
const REPO_NAME = 'Support-Engineer'
...
export default defineConfig({
  ...
  plugins: [react()],
  build: {
    // Multi-page: the landing plus two frozen "state" pages that the GitHub
    // Actions workflows publish as index.html when taking the site into
    // maintenance / unpublishing it. They reuse the same bundle.
    rollupOptions: {
      input: {
